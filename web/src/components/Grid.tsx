...
const COLS = "grid grid-cols-[188px_repeat(5,minmax(0,1fr))]";
          ...
          return (
            ...
            >
              <div className="flex flex-col justify-center px-4 py-5">
                ...
                {slug && (
                  <div className="mt-0.5 truncate font-mono text-xs text-muted-foreground" title={slug}>
                    {slug}
                  </div>
                )}
              </div>
